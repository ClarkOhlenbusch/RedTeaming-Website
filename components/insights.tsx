...
export function Insights() {
  ...
  return (
    <section id="insights" className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-navy-800 dark:text-white mb-4">Latest Insights</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
              Expert perspectives on the latest trends in cybersecurity, wireless technology, and strategic advisory.
            </p>
          </div>
          <Button variant="outline" className="mt-6 md:mt-0 self-start md:self-auto">
            View All Insights
          </Button>
        </div>
          ...
          {insights.map((insight, index) => (
            <Card key={index} className="overflow-hidden border-0 shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardHeader className="pt-6">
                <div className="text-sm font-medium text-red-700 mb-2">{insight.category}</div>
                <CardTitle className="text-xl font-bold text-navy-800 dark:text-white">{insight.title}</CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter className="flex justify-between items-center border-t pt-4">
                <div className="text-sm text-gray-500 dark:text-gray-400">{insight.date}</div>
                <Link href="#" className="text-sm font-medium text-red-700 hover:text-red-800 dark:hover:text-red-600">
                  Read More
                </Link>
              </CardFooter>
            </Card>
